...
def is_match(fave_numbers_1, fave_numbers_2):
    ...
    ----------
    fave_numbers_1 : list
        list of user number 1 favorite numbers
    fave_numbers_2 : list
        list of user number 2 favorite numbers
    
    Returns
    ----------
    boolean 
        True if all numbers in fave_numbers_2 are present in fave_numbers_1, False otherwise
    """
